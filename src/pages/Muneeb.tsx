...
const Muneeb: React.FC = () => {
    ...
    const handleLinkedInClick = () => {
        handleIconTap();
        window.open("https://www.linkedin.com/in/muneebcholayil/", "_blank");
    };

    const handleWhatsappClick = () => {
        handleIconTap();
        window.open("https://wa.me/971567001568", "_blank");
    };
    ...
    const handleShareClick = async () => {
        ...
        if (navigator.share) {
            try {
                await navigator.share({ title: "Muneeb Cholayil - Aurify", url: shareUrl });
                return;
            } catch { }
        }
    ...
    const handleSaveClick = () => {
        ...
        link.href = url;
        link.download = "Muneeb_Cholayil.vcf";
    ...
    const handlePhoneClick = () => {
        handleIconTap();
        const link = document.createElement("a");
        link.href = "tel:+971567001568";
        link.click();
    };

    const handleMailClick = () => {
        handleIconTap();
        window.location.href = "mailto:muneeb@aurify.global";
    };
            ...
            <div className="relative w-full max-w-[380px] mx-auto rounded-3xl shadow-[0_20px_60px_rgba(30,80,160,0.18),0_4px_16px_rgba(0,0,0,0.10)] bg-white overflow-hidden pb-10">
                ...
                <div className="relative z-30 bg-white rounded-tr-[90px] -mt-30 pt-7 pb-8 px-6 mx-4 shadow-[0_20px_60px_rgba(30,80,160,0.18),0_4px_16px_rgba(0,0,0,0.10)]">
                    ...
                    <div className="text-center mb-7">
                        ...
                        <p className="text-sm text-[#1D3E71] mt-1 font-normal">CEO</p>
                    </div>
